...
class AirportListViewController: UITableViewController {
    ...
    //Split different countries into different arrays, the data would be like:
    //[[[country:taiwan,city:kaohisung],[country:taiwan,city:taipei]],[[country:china,city:shanghai],[country:china.city:namjing]]]
